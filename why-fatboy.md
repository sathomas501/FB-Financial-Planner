---
layout: default
title: Why Fatboy Financial Planner - Tax Laws Change, Your Calculator Shouldn't Be Stuck in 2024
description: The TCJA to OBBBA transition proved why editable tax parameters matter. Most retirement calculators became obsolete overnight. Fatboy users kept planning. Here's why our approach is different.
keywords: retirement planning software, editable tax parameters, OBBBA planning, TCJA expiration, flexible retirement calculator, tax law changes
---
...
**December 2024:**
- Tax Cuts and Jobs Act (TCJA) set to expire December 31, 2025
- Tax rates would increase from 22% to 25%, 24% to 28%
- Standard deduction would drop from $29,200 to $15,000
- Retirement planners panicked: "Should we convert to Roth now?"
...
- TCJA brackets made PERMANENT (22% and 24% stay)
- NEW $6,000 senior deduction added (2026-2028 only)
- Estate tax exemption increased to $15M
- TSP to Roth TSP conversions now allowed
...
- 2001: EGTRRA passed (Bush tax cuts)
- 2003: JGTRRA passed (capital gains changes)
- 2010: Tax Relief Act (estate tax changes)
- 2012: ATRA passed (fiscal cliff resolution)
- 2017: TCJA passed (major overhaul)
- 2025: OBBBA passed (TCJA extension + new provisions)
...
Your 2027 retirement plan assumes 2024 tax rates that don't exist anymore.

**❌ You can't model "what if" scenarios**
What if Congress changes tax rates in 2027? You have no way to model it.

**❌ You're dependent on vendor updates**
Your $100/year subscription gets you... waiting for updates.

**❌ Your plan is always 1-2 years behind current law**
By the time software updates, the law has changed again.
...
- You get an extra $6,000-$12,000 deduction
- Conversions are 10-20% cheaper than in 2029+
- Strategic timing can save $3,000-$10,000 in taxes

**Most retirement calculators:**
- Don't have senior deduction coded yet (as of January 2026)
- When they add it, might not code the 2028 sunset correctly
- Might show senior deduction forever (wrong)
- Or might not show it at all (also wrong)
- **Users making $100,000+ decisions based on wrong math**

**Fatboy approach:**
- Edit standard deduction for 2026-2028: Add $12,000 (senior deduction)
- Edit standard deduction for 2029+: Back to $31,500 (senior deduction expired)
- Run Roth conversion scenarios comparing 2026-2028 vs 2029+
- See exactly how much the senior deduction saves
- Make informed decisions about conversion timing
...
- OBBBA senior deduction expires 2028 (guaranteed)
- Social Security funding crisis (2034 trust fund depletion)
- Capital gains rate changes (frequently proposed)
- IRMAA bracket adjustments (happens constantly)
- RMD age increases (changed twice in 5 years)
- Estate tax exemption changes (political football)

**With hardcoded software:**
You're stuck until vendor updates. Months of planning paralysis.

**With Fatboy:**
You edit the parameters yourself. Keep planning through the uncertainty.
...
**Hardcoded software approach:**
"TCJA will expire December 31, 2025. Here's your plan assuming 2017 tax rates return."

**Problem:** That's not what happened. OBBBA passed instead. Your plan is wrong.

**Fatboy approach:**
Run three scenarios:
- Scenario A: TCJA expires as scheduled (25%, 28% brackets)
- Scenario B: TCJA extended permanently (22%, 24% brackets)
- Scenario C: Partial extension or modification (mix of rates)
...
- Closest to Scenario B (permanent TCJA rates)
- But with additions (senior deduction)
- Easy to update Scenario B with senior deduction
- Strategies were already robust across scenarios
...
Trusting a black box with hardcoded parameters you can't see, can't verify, and can't update when wrong.
...
- Wait 6-18 months for vendor updates
- Plan with outdated numbers
- Make decisions based on wrong assumptions
- Hope the vendor eventually updates correctly

**Fatboy users:**
- Read our blog post explaining the changes (published within days)
- Update tax parameters yourself (takes 10 minutes)
- Run new scenarios immediately
- Make decisions based on current law
...
✓ Monte Carlo simulations (sequence of returns risk)
✓ Roth conversion optimization
✓ IRMAA bracket analysis
✓ RMD calculations
...
**December 2024:**
Most retirement software: "TCJA expires in 12 months. Your taxes are going up 20-30%."

**Fatboy blog:** ["TCJA Expiration 2026: The Tax Bomb Nobody's Modeling"]({{ site.baseurl }}{% post_url 2025-01-14-TCJA-Tax-Expiration %})
Explained what expiration would mean. Showed users how to model it. Recommended hedging strategies.

**July 2025:**
OBBBA passes. TCJA made permanent. New senior deduction added (2026-2028).

Most retirement software: Obsolete. Wrong numbers. Waiting for updates.

**Fatboy blog:** ["OBBBA Changes Everything"]({{ site.baseurl }}{% post_url 2025-01-19-OBBBA-One-Big-Beautiful-Bill %})
Published within days. Explained new law. Showed exactly which parameters to update.
...
**Our blog post said:**
"Edit standard deduction for 2026-2028: Add $12,000 (married, both 65+). Set it back to regular standard deduction for 2029+. Then run Roth conversion scenarios for 2026-2028 vs 2029+ to see the tax savings."

**You do:**
- Open tax parameters
- Edit standard deduction 2026: $31,500 + $12,000 = $43,500
- Edit standard deduction 2027: $43,500 (with inflation)
- Edit standard deduction 2028: $43,500 (with inflation)
- Edit standard deduction 2029: $31,500 (senior deduction expired)
- Save
- Run scenarios
...
✓ Want to control their own retirement planning
✓ Don't trust black box calculators
✓ Need to model tax law changes
✓ Value accuracy over simplicity
✓ Are willing to learn (but don't need a PhD)
✓ Want software that doesn't become obsolete every time Congress passes a bill

**This is NOT for people who:**

❌ Want a "set it and forget it" calculator
❌ Trust vendor updates to always be timely and correct
❌ Don't care about tax optimization
❌ Are satisfied with generic retirement advice
...
[Download Free Version]({{ site.url }}{{ site.baseurl }}/#download-free-version)

**Upgrade to Pro** when you need unlimited scenarios, advanced Monte Carlo controls, and professional PDF reports.

[See Pricing]({{ site.url }}{{ site.baseurl }}/pricing)

**Read the OBBBA analysis** to understand current tax law and optimal 2026-2028 strategies.

[Read: OBBBA Changes Everything]({{ site.baseurl }}{% post_url 2025-01-19-OBBBA-One-Big-Beautiful-Bill %})
