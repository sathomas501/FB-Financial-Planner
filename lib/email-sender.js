...
async function sendLicenseEmail({ to, customerName, licenseKey, downloadUrl, orderId }) {
  const emailHtml = `
    ...
    <body>
      <div class="header">
        <img src="https://www.fatboysoftware.com/assets/images/optimized/Fatboy_Software_Logo.png"
      ...
      <div class="content">
        ...
        <div style="background: #f0f8ff; border-left: 4px solid #0066cc; padding: 15px; margin: 20px 0;">
          <p style="margin: 0; font-size: 14px;">
            ...
            <a href="https://www.fatboysoftware.com/thank-you" style="color: #0066cc;">Download Fatboy Financial Planner</a> (Windows & Linux)
          </p>
        </div>
        ...
        <ul>
          <li>Visit our website: <a href="https://www.fatboysoftware.com">fatboysoftware.com</a></li>
          <li>Installation guide: <a href="https://www.fatboysoftware.com/thank-you">Download & Setup Instructions</a></li>
