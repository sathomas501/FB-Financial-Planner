...
faq_schema:
  ...
  mainEntity:
    - "@type": "Question"
      ...
      acceptedAnswer:
        "@type": "Answer"
        text: "IRMAA is the Income-Related Monthly Adjustment Amount, a surcharge added to Medicare Part B and Part D premiums for beneficiaries with higher income."
    - "@type": "Question"
      name: "Do Roth conversions affect IRMAA?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Yes. Roth conversion income increases MAGI and can trigger higher Medicare premiums two years later."
    - "@type": "Question"
      name: "Why is IRMAA so easy to miss?"
      acceptedAnswer:
        "@type": "Answer"
        text: "IRMAA is based on income from two years earlier, so people often make a Roth conversion or realize gains and do not feel the Medicare cost until later."
    - "@type": "Question"
      name: "Can one extra dollar of income trigger IRMAA?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Yes. IRMAA works in cliffs, not smooth phases, so crossing a threshold by a very small amount can cost thousands in extra premiums."
    - "@type": "Question"
      name: "How can retirees reduce IRMAA risk?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Retirees can reduce IRMAA risk by planning income two years ahead, sizing Roth conversions carefully, spreading large income events across multiple years, and coordinating withdrawals with Medicare thresholds."
---
...
**If you're planning early retirement, FIRE, or Coast FIRE, this is a huge opportunity.**
